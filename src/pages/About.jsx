  ...
  return (
    <div className="max-w-content mx-auto px-6 md:px-10 pt-12 md:pt-20 pb-20">
      <div className="max-w-2xl">
        ...
        <p className="font-sans text-text-muted text-sm md:text-base mb-12">
          数字产品设计师｜复杂系统 · Vibe Coding · 设计系统与交付效率
        </p>

        {/* Bio */}
        <div className="space-y-6 text-text-primary leading-relaxed text-[15px] md:text-base">
          <p>
            你好👋，我是赵子瑞 🧑🏻‍💻。
          </p>
          <p>
        ...
        {/* Social Icons */}
        <div className="flex items-center gap-8 mt-14 mb-12">
          {/* X (Twitter) */}
        ...
        <div>
          ...
          <p className="font-mono text-base font-medium text-text-primary mb-2">
            13260951210
          </p>
